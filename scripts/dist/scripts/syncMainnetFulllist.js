...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            logger_1.logger.info('Starting sync mainnet fulllist');
            ...
            const tokenShortList = (0, file_1.readJsonFile)(config_1.config.TOKEN_SHORT_LIST_PATH);
            ...
            yield tokenService.processTokenEvents();
            tokenService.concatTokenShortList(tokenShortList);
            tokenService.exportTokenList();
            logger_1.logger.info('Sync mainnet fulllist succesfully executed');
        }
        catch (error) {
